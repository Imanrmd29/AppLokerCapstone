...
import com.c22_054.apploker.databinding.FragmentWebDevBinding
import com.c22_054.apploker.ui.category.CategoryFragment

class WebDevFragment : Fragment() {
    private lateinit var binding: FragmentWebDevBinding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding = FragmentWebDevBinding.inflate(layoutInflater)
        return binding.root
    }
